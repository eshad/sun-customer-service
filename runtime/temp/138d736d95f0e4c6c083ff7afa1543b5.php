<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/var/www/html/www.kefu.com/public/../application/mobile/view/index/index.html";i:1721302320;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<script>
    ...
    <div class="foot_all" style="position:fixed;bottom:0px;width: 100%;height: 94px;padding:0;z-index: 997">
        ...
        <div class="foot_msg">
            <div class="footer" style="top:-15px">
                <input type="text" id="text_in" placeholder="<?php echo $lang['please_enter']; ?>" class="layui-input" autocomplete="off"/>
                <button class="layui-btn layui-btn-normal send-btn" style="background-color: #000722; height: 32px"
