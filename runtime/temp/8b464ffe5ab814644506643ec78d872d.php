<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/var/www/html/www.kefu.com/public/../application/service/view/login/reg.html";i:1715055254;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title><?php echo (isset($business['business_name']) && ($business['business_name'] !== '')?$business['business_name']:"在线客服管理系统"); ?></title>
    ...
    <style>
        ...
        .login-main .login-bottom .center .item .icon-1 {background:url(/static/admin/images/icon-login.png) no-repeat 1px 0;}
        .login-main .login-bottom .center .item .icon-2 {background:url(/static/admin/images/icon-login.png) no-repeat -54px 0;}
        .login-main .login-bottom .center .item .icon-3 {background:url(/static/admin/images/icon-login.png) no-repeat -106px 0;}
        .login-main .login-bottom .center .item .icon-4 {background:url(/static/admin/images/icon-login.png) no-repeat 0 -43px;position:absolute;right:-10px;cursor:pointer;}
        ...
        body {background: url(/static/admin/images/loginbg.png) no-repeat;position:static;font-size:12px;}
    ...
    <div class="login-main">
        ...
        <form class="layui-form login-bottom">
            ...
            <div class="layui-form-item" style="text-align:center; width:100%;height:100%;margin:0px;">
                <button class="login-btn" lay-submit="" lay-filter="login">立即注册</button>
            </div>
        </form>
    </div>
</div>
<div class="footer">
    ©版权所有 <?php echo date('Y'); ?> AI客服系统
</div>
