<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/var/www/html/www.kefu.com/public/../application/backend/view/busines/edit.html";i:1715055248;}*/ ?>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="lang">
                            ...
                            <?php $_666d813dca5ac=config('lang'); if(is_array($_666d813dca5ac) || $_666d813dca5ac instanceof \think\Collection || $_666d813dca5ac instanceof \think\Paginator): if( count($_666d813dca5ac)==0 ) : echo "" ;else: foreach($_666d813dca5ac as $key=>$vo): ?>
