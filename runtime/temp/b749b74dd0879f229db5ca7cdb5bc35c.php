<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/var/www/html/www.kefu.com/public/../application/service/view/questions/index.html";i:1715055254;}*/ ?>
						...
						<div class="layui-form-item layui-inline">
							...
							<div class="layui-input-inline">
								<select name="lang">
									...
									<?php $_6655ddc45d2ae=config('lang'); if(is_array($_6655ddc45d2ae) || $_6655ddc45d2ae instanceof \think\Collection || $_6655ddc45d2ae instanceof \think\Paginator): if( count($_6655ddc45d2ae)==0 ) : echo "" ;else: foreach($_6655ddc45d2ae as $key=>$vo): ?>
