<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/var/www/html/www.kefu.com/public/../application/index/view/index/index.html";i:1715765882;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
    <link rel="shortcut icon" href="/favicon.ico"/>
    <title><?php echo $webs; ?></title>
    <script>
...
<body style="background: url(<?php echo $chatbg; ?>) repeat;">
       ...
       function title(){
        ...
        var wolive_connect =function () {
            ...
            channels.bind('first_word',function(data){
                ...
                msg += '<img class="my-circle  se_pic" src="<?php echo $avatar; ?>" width="40px" height="40px"></div>';
                msg += "<div class='outer-left'><div class='service'>";
                msg += "<pre>" + data.message.content + "</pre>";
                msg += "</div></div>";
                msg += "</li>";
...
<div style="width: 40%;height: 90%;min-height:500px;min-width:500px;margin: 3% auto;position: relative;box-shadow: 0 0 24px 0 rgb(15 66 76 / 25%);margin-left: 23%;">
      <!--  对话框头部 -->
     <div class="header grey12" style="background-color: #000722;">
         <img id="pinpai" src="<?php echo $pinpai; ?>" style="width: 46px;height: 46px;border-radius: 50%;position: absolute;left: 10px;top: 7px;">
        <span id="services" style="color: #ffffff;margin-left:65px;"></span>
    ...
    <div class="workarea">
        ...
        <div class="footer widths">
            ...
            <div class="msg-toolbar-footer grey12" >
                <a onclick="send()" class="layui-btn msg-send-btn" style="background-color:#000722;">
                    <?php echo $lang['send']; ?>
                 </a>
                 <a id="showinfo" class="showinfo" style="background-color:#000722;">
            ...
            <div class="msg-toolbar">
                ...
                <a id="files" href="javascript:">
                 ...
                 <a onclick="hint()" id="clickbf" style="margin-top: -5px;"><i class="layui-icon state-mp3" style="font-size: 25px;cursor: pointer;color: #999999">&#xe685;</i></a>
...
<div id="xxxx" style="width: 34.9%;height: 100%;position: absolute;top:-1px;left: 100%;background: #fff;border: 1px solid #ddd;overflow-x: hidden;border-left:#fff;">
    <div class="" style="height:64px;background-color:#000722;"></div>
 <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief" style="margin: 0px;height: 50px;background-color: #f7f7f7">
   <ul class="layui-tab-title" id="tablist" style="height: 50px;border-bottom: 0;width: 100%">
    ...
    <div class="layui-tab-content" id="tabcontent">
         <div class="layui-tab-item layui-show" id="question_list" style="width: 100%;overflow-y: auto; top:0px;">
    </div>
  </div>
    <div class="" style="position:relative;/*  bottom:-55%; margin-left:20px; */padding: 10px;">
      <a target="_blank" href="<?php echo $adurl; ?>">
          <img src="<?php echo $charad; ?>" style="max-width: 160px;padding: 10px;">
          <div style="width:100%;margin-bottom:10px; cursor: pointer;color: #2196F3;font-size: 13px;"><?php echo $jieshao; ?></div>
      </a>
  </div>
  </div>
</div>
