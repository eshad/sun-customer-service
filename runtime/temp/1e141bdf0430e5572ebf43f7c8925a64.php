<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/var/www/html/www.kefu.com/public/../application/service/view/banwords/index.html";i:1715055254;}*/ ?>
						...
						<div class="layui-form-item layui-inline">
							...
							<div class="layui-input-inline">
								<select name="lang">
									...
									<?php $_6655ddc2d24bb=config('lang'); if(is_array($_6655ddc2d24bb) || $_6655ddc2d24bb instanceof \think\Collection || $_6655ddc2d24bb instanceof \think\Paginator): if( count($_6655ddc2d24bb)==0 ) : echo "" ;else: foreach($_6655ddc2d24bb as $key=>$vo): ?>
