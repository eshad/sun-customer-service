<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"/var/www/html/www.kefu.com/public/../application/service/view/setting/sentence_add.html";i:1715055254;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="lang" lay-verify="required">
                        <?php $_66771f7cededb=config('lang'); if(is_array($_66771f7cededb) || $_66771f7cededb instanceof \think\Collection || $_66771f7cededb instanceof \think\Paginator): if( count($_66771f7cededb)==0 ) : echo "" ;else: foreach($_66771f7cededb as $key=>$vo): ?>
