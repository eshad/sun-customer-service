<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/var/www/html/www.kefu.com/public/../application/backend/view/index/home.html";i:1715055248;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
		<title>首页三 吾爱源码www.52oc.cn</title>
				...
				<div class="layui-col-xs6 layui-col-md3">
					<div class="layui-card ">
						...
						<div class="layui-card-footer">
							客服总数：<?php echo $data['total_service']; ?>
						</div>
					</div>
				</div>
				<div class="layui-col-xs6 layui-col-md3">
					<div class="layui-card">
						...
						<div class="layui-card-footer">
							接待总用户数：<?php echo $data['total_int']; ?>
						</div>
					</div>
				</div>
				<div class="layui-col-xs6 layui-col-md3">
					<div class="layui-card">
						...
						<div class="layui-card-footer">
							聊天消息总数：<?php echo $data['total_chats']; ?>
						</div>
					</div>
				</div>
				<div class="layui-col-xs6 layui-col-md3">
					<div class="layui-card">
						...
						<div class="layui-card-footer">
							总评价数：<?php echo $data['total_comment']; ?>
						</div>
					</div>
				</div>
			</div>
