<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/www/wwwroot/www.kefu.com/public/../application/index/view/index/index.html";i:1715055252;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
...
<div id="xxxx" style="width: 34.9%;height: 100%;position: absolute;top:-1px;left: 100%;background: #fff;border: 1px solid #ddd;overflow-x: hidden;border-left:#fff;">
    <div class="" style="height:64px;background-color:#<?php echo $theme; ?>;"></div>
