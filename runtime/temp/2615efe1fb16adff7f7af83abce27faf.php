<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/var/www/html/www.kefu.com/public/../application/service/view/setting/access.html";i:1715055254;}*/ ?>
    ...
    <link href="/assets/libs/bootstrap/bootstrap.min.css?v=AI_KF" type="text/css" rel="stylesheet"/>
    
    <link href="/assets/css/admin/common.css?v=AI_KF" type="text/css" rel="stylesheet" />
    <link href="/assets/css/admin/admin.css?v=AI_KF" type="text/css" rel="stylesheet" />
    <link href="/assets/css/admin/reload.css?v=AI_KF" type="text/css" rel="stylesheet" />
    ...
    <link href="/assets/css/admin/set.css?v=AI_KF" type="text/css" rel="stylesheet" />
    <script src="/assets/js/admin/common_me.js?v=AI_KF" type="text/javascript"></script>
    ...
    <script type="text/javascript" src="/assets/libs/web_socket/swfobject.js?v=AI_KF"></script>
    <script type="text/javascript" src="/assets/libs/web_socket/web_socket.js?v=AI_KF"></script>
    <script type="text/javascript" src="/assets/js/admin/online.js"></script>
    <meta name="renderer" content="webkit">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <link href="/assets/css/admin/ymwl_common.css?v=AI_KF" type="text/css" rel="stylesheet" />
    <style>
        .my-setting {
            margin: 10px 0px;
            background: #fff;
...
" onclick="buildpersonal()">生成我的专属链接</button>-->
                    <?php echo hook('generatelinkhook', ['id'=>1]); ?>
                ...
                <div class="layui-card-body">
                    <form class="layui-form" id="form-diy">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="hidden" name="m_kfbtbg" placeholder="请选择颜色" class="layui-input" id="m_kfbtbg" value="#<?php echo $business['header']; ?>">
                            </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="hidden" name="theme" placeholder="请选择颜色" class="layui-input" id="theme" value="#<?php echo $business['theme']; ?>">
                            </div>
                            <div class="layui-inline">
...
<script>
    ...
    layui.use(['form','code','colorpicker'], function(){
        ...
        colorpicker.render({
            elem: '#test-form'
            ,color: '#<?php echo $business['header']; ?>'
            ,done: function(color){
                $('#m_kfbtbg').val(color);
            }
        });
...
var buildpersonal = function () {
    ...
    if($type == 0){
        ...
        domPersonal.text("<?php echo $action; ?>/index/index/home?visiter_id=&visiter_name=&avatar=&business_id=<?php echo $login['business_id']; ?>&groupid=<?php echo $login['groupid']; ?>&special=<?php echo $login['service_id']; ?>&theme="+theme);
    }
};
