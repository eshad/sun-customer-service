<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/www/wwwroot/www.kefu.com/public/../application/service/view/setting/index.html";i:1715055254;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-form-item" style="margin-top: 20px">
                ...
                <div class="layui-input-inline">
                    <select name="lang" lay-verify="required">
                        ...
                        <?php $_663f8eedd6911=config('lang'); if(is_array($_663f8eedd6911) || $_663f8eedd6911 instanceof \think\Collection || $_663f8eedd6911 instanceof \think\Paginator): if( count($_663f8eedd6911)==0 ) : echo "" ;else: foreach($_663f8eedd6911 as $key=>$vo): ?>
