<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/var/www/html/www.kefu.com/public/../application/service/view/index/home.html";i:1715055254;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
			...
			<div class="layui-row layui-col-space10">
				<div class="layui-col-xs6 layui-col-md3">
					<div class="layui-card ">
						<div class="layui-card-header">当前咨询用户数</div>
						...
						<div class="layui-card-footer">
							当前在线客服数：<?php echo $services; ?>
						</div>
					</div>
				</div>
				<div class="layui-col-xs6 layui-col-md3">
					<div class="layui-card">
						<div class="layui-card-header">当前排队用户数</div>
						<div class="layui-card-body">
							<div class="layui-row layui-col-space5">
						...
						<div class="layui-card-footer">
							接待总用户数：<?php echo $getinall; ?>
						</div>
					</div>
				</div>
				<div class="layui-col-xs6 layui-col-md3">
					<div class="layui-card">
						<div class="layui-card-header">今日聊天消息数</div>
						<div class="layui-card-body">
							<div class="layui-row layui-col-space5">
						...
						<div class="layui-card-footer">
							聊天消息总数：<?php echo $chatsall; ?>
						</div>
					</div>
				</div>
				<div class="layui-col-xs6 layui-col-md3">
					<div class="layui-card">
						<div class="layui-card-header">今日评价用户数</div>
						<div class="layui-card-body">
							<div class="layui-row layui-col-space5">
								<div class="layui-col-xs8 layui-col-md8 top-panel-number" style="color: #28333E;" id="value4">
									<?php echo $nowcomments; ?>
								</div>
								<div class="layui-col-xs4 layui-col-md4 top-panel-tips">
		...
		<script>
            layui.use(['echarts'], function() {
                ...
                option = {
                    ...
                    xAxis: [{
                        type: 'category',
                        data: <?php echo json_encode(array_column($chatsdata,'date')); ?>,
                        axisLine: {
                            lineStyle: {
                                color: '#DCE2E8'
                            }
                    ...
                    series: [{
                        name: '会话总量',
                        type: 'line',
                        data: <?php echo json_encode(array_column($chatsdata,'chat')); ?>,
                        symbolSize: 1,
                        symbol: 'circle',
                        smooth: true,
                        yAxisIndex: 0,
                        ...
                        name: '接入会话总量',
                        type: 'line',
                        data: <?php echo json_encode(array_column($chatsdata,'line')); ?>,
                        symbolSize: 1,
                        symbol: 'circle',
                        smooth: true,
                        yAxisIndex: 0,
                    ...
                    },
                        {
                            name: '评价人数',
                            type: 'line',
                            data: <?php echo json_encode(array_column($chatsdata,'comment')); ?>,
                            symbolSize: 1,
                            yAxisIndex: 1,
                            symbol: 'circle',
                            smooth: true,
