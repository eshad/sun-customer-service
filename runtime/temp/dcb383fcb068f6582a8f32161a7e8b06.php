<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/var/www/html/www.kefu.com/public/../application/backend/view/login/index.html";i:1715055248;}*/ ?>

<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <title>登录-多商户客服后台管理系统 吾爱源码www.52oc.cn</title>
  <!-- 样 式 文 件 -->
...
<form class="layui-form" action="javascript:void(0);">
  <div class="layui-form-item">
    ...
    <div class="desc">
      多 商 户 客 服 后 台 管 理 系 统吾爱源码www.52oc.cn
    </div>
  </div>
  <div class="layui-form-item">
  ...
  <div class="layui-form-item">
    ...
    <br/>  <br/>  <br/>  <br/>  <br/>  <br/>吾爱源码www.52oc.cn
  </div>
</form>
