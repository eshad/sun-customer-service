<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/var/www/html/www.kefu.com/public/../application/service/view/questions/add.html";i:1715055254;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="mainBox">
        <div class="main-container">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="lang" lay-verify="required">
                        <?php $_6681196bb9b11=config('lang'); if(is_array($_6681196bb9b11) || $_6681196bb9b11 instanceof \think\Collection || $_6681196bb9b11 instanceof \think\Paginator): if( count($_6681196bb9b11)==0 ) : echo "" ;else: foreach($_6681196bb9b11 as $key=>$vo): ?>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="question" value="" lay-verify="required" placeholder="请输入常见问题"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="keyword" value="" lay-verify="required" placeholder="请输入关键词(最多6个字)"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea class="editormd-markdown-textarea" name="answer" id="a_editormd" style="height: 260px;"></textarea>
                </div>
            </div>
        </div>
    </div>
