<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/www/wwwroot/www.kefu.com/public/../application/index/view/index/pc.html";i:1715055252;}*/ ?>
<html>
<head>
        ...
        <div class="zc-navigation-outer clearfix">
            ...
            <div class="zc-navigation-button clearfix">
                <div class="buttons-outer">
                    ...
                    <div class="cover">
                        <a class="top-btn top-btn-register btn btn-register" style="position: relative" href="/service/login/reg">免费试用
                        </a>
                    </div>
                    <?php else: ?>
                    <div class="cover">
                        <a class="top-btn top-btn-register btn btn-register" style="position: relative;padding: 0 10px" href="/service/index">进入工作台
                        </a>
                    </div>
                    <?php endif; ?>
                </div>
...
<div class="banner-outer" id="index_1">
    <div class="banner-inner"><h1>全渠道智能在线客服<br>统一管理，智能服务</h1>
        ...
        <div class="buttons">
            <a href="/service/login/reg" class="btn">免费试用<?php echo config('default_reg_day'); ?>天</a>
        </div>
    </div>
</div>
<div class="detail-item" id="index_2">
    ...
    <div class="href-wrap">
        <a href="/service/login/reg" target="_blank" class="one">立即注册，亲自体验产品</a>
    </div>
</div>
