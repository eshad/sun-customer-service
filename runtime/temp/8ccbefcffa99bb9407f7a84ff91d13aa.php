<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"/var/www/html/www.kefu.com/public/../application/service/view/setting/sentence_edit.html";i:1715055254;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="lang" lay-verify="required">
                        <?php $_6677200819af1=config('lang'); if(is_array($_6677200819af1) || $_6677200819af1 instanceof \think\Collection || $_6677200819af1 instanceof \think\Paginator): if( count($_6677200819af1)==0 ) : echo "" ;else: foreach($_6677200819af1 as $key=>$vo): ?>
