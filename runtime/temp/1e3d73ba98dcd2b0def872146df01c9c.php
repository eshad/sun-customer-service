<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/www/wwwroot/www.kefu.com/public/../application/service/view/questions/index.html";i:1715055254;}*/ ?>
						...
						<div class="layui-form-item layui-inline">
							...
							<div class="layui-input-inline">
								<select name="lang">
									...
									<?php $_6639ab4325fea=config('lang'); if(is_array($_6639ab4325fea) || $_6639ab4325fea instanceof \think\Collection || $_6639ab4325fea instanceof \think\Paginator): if( count($_6639ab4325fea)==0 ) : echo "" ;else: foreach($_6639ab4325fea as $key=>$vo): ?>
