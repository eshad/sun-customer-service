<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/www.kefu.com/public/../application/service/view/index/index.html";i:1715055254;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <script type="text/javascript" src="/assets/js/admin/online.js?v=20210929"></script>
  ...
  <div class="layui-header">
    ...
    <ul class="layui-nav layui-layout-right" lay-filter="layui_nav_right">
      ...
      <li class="layui-nav-item user">
        <!-- 头 像 -->
        <a href="javascript:;">
          <img src="<?php echo $arr['avatar']; ?>" class="layui-nav-img">
          <?php echo $arr['nick_name']; ?>
...
<script>
    layui.use(['admin', 'jquery', 'layer','element'], function() {
        ...
        admin.render({
            ...
            "menu": {
                "data": "<?php echo url('service/index/menu'); ?>",
                "accordion": true,
                "control": false,
                "select": "0"
            },
            "tab": {
                ...
                "index": {
                    "id": "0",
                    "href": "<?php echo url('service/index/home'); ?>",
                    "title": "首页"
                }
            },
            "theme": {
        ...
        layelem.on('nav(layui_nav_right)', function(elem) {
            if ($(elem).hasClass('logout')) {
                layer.confirm('确定退出登录吗?', function(index) {
                    layer.close(index);
                    $.ajax({
                        url: "<?php echo url('service/login/logout'); ?>",
                        type:"POST",
                        dataType:"json",
                        success: function(res) {
                            if (res.code==1) {
                                ...
                                setTimeout(function() {
                                    location.href = "<?php echo url('service/login/index'); ?>";
                                }, 333)
                            }
                        }
                    });
                ...
                layer.open({
                    ...
                    shade: 0.1,
                    area: ['400px', '300px'],
                    content:"<?php echo url('service/index/pass'); ?>"
                });
            }else if ($(elem).hasClass('cache')) {
                $.post("<?php echo url('service/index/cash'); ?>",
                    function(data){
