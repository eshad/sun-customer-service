...
class Index extends Controller
{
    ...
    public function index()
    {
        ...
        $this->assign('chatbg',$business['chatbg']);
        $this->assign('charad',$business['charad']);
        $this->assign('jieshao',$business['jieshao']);
        $this->assign('pinpai',$business['pinpai']);
        $this->assign('adurl',$business['adurl']);
